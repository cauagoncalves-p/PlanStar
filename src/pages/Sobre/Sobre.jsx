        ...
        <div>
            ...
            <main>
                ...
                <section class="team-section">
                    <h2 class="team-title">Conheça a equipe que deu início a tudo</h2>
                ...
                <section class="start-section" id="history">
                    <div class="start-inner">
                        <h2 class="start-title">Como tudo começou</h2>
