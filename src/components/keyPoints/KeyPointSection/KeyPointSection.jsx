...
const KeyPointSection = () =>{
    return(
        ...
        <div className={styles.keyPoints_div}>
            ...
            <KeyPoints image={iconIMGClipBoard} alt="Icone Leveza sem complicação" title="Leveza sem complicação" describe=" Transformamos sua rotina de forma simples, prática e sem estresse.
              Você só segue passos claros e sente o dia a dia ficando mais leve."/>

            <KeyPoints image={iconIMGClipBoard} alt="Icone Acompanhamento contínuo" title="Acompanhamento contínuo" describe="   Você não fica sozinho. A PlanStar acompanha seu progresso e ajuda a
              ajustar sua rotina sempre que necessário."/>

            <KeyPoints image={iconIMGClipBoard} alt="Icone Clareza e foco" title="Clareza e foco" describe="  Chega de sobrecarga mental. Te ajudamos a organizar prioridades para
              que você tenha clareza do que realmente importa."/>

            <KeyPoints image={iconIMGClipBoard} alt="Icone Bem-estar em primeiro lugar" title="Bem-estar em primeiro lugar" describe=" Não é só sobre produtividade — é sobre você. A PlanStar ajuda a
              equilibrar rotina, descanso, estudo e vida pessoal."/>
              
            <KeyPoints image={iconIMGClipBoard} alt="Icone Método humanizado" title="Método humanizado" describe=" Nada de rigidez. Respeitamos seu ritmo, suas limitações e seu
